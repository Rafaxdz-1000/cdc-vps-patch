...
go('VEND_S1', {"layout": "illustration", "slide_index": 1, "total": 4, "categoria": "",
    ...
    "tag": "VENDAS", "filename_base": "cdc_test_vend_s1", "bg_prompt": "soft abstract shapes"})
go('VEND_S2', {"layout": "illustration", "slide_index": 2, "total": 4, "categoria": "O problema",
    ...
    "site": "clubedoscisnes.com", "filename_base": "cdc_test_vend_s2", "bg_prompt": "x"})
go('ENS_S1', {"layout": "tweet", "slide_index": 1, "total": 4, "titulo": "",
    ...
    "filename_base": "cdc_test_ens_s1", "bg_prompt": "abstract glowing blue neural network on dark background, no text"})
go('ENS_S2', {"layout": "tweet", "slide_index": 2, "total": 4,
    ...
    "filename_base": "cdc_test_ens_s2", "bg_prompt": ""})
print('DONE_TEST')
